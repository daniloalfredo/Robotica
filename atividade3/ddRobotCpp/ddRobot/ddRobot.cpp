...
int main(int argc, char* argv[])
{
    ...
    simxFloat distanceSonarL = 0;
    simxFloat distanceSonarR = 0;
    simxFloat distanceSonarF = 0;
    ...
    if (clientID != -1) {
        ...
        {    
            ...
            //Set robot goal
            simxFloat goal[3]; goal[0] = 1; goal[1] = -1; goal[2] = 0;
            ...
            distanceSonarL = readSonar(clientID,sonarL);
            distanceSonarR = readSonar(clientID,sonarR);
            distanceSonarF = readSonar(clientID,sonarF);
